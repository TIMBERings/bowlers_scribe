...
ActiveRecord::Schema.define(version: 20161114042490) do
  ...
  create_table "members_seasons", id: false, force: :cascade do |t|
    t.integer  "member_id"
    t.integer  "season_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["member_id"], name: "index_members_seasons_on_member_id", using: :btree
    t.index ["season_id"], name: "index_members_seasons_on_season_id", using: :btree
  end
