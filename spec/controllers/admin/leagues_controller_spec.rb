...
RSpec.describe Admin::LeaguesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all admin_leagues as @admin_leagues" do
      ...
      expect(assigns(:admin_leagues)).to eq([league])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested admin_league as @admin_league" do
      ...
      expect(assigns(:admin_league)).to eq(league)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new admin_league as @admin_league" do
      ...
      expect(assigns(:admin_league)).to be_a_new(Admin::League)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Admin::League" do
        expect {
          post :create, params: {admin_league: valid_attributes}, session: valid_session
        }.to change(Admin::League, :count).by(1)
      end

      it "assigns a newly created admin_league as @admin_league" do
        post :create, params: {admin_league: valid_attributes}, session: valid_session
        expect(assigns(:admin_league)).to be_a(Admin::League)
        expect(assigns(:admin_league)).to be_persisted
      end

      it "redirects to the created admin_league" do
        post :create, params: {admin_league: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Admin::League.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved admin_league as @admin_league" do
        post :create, params: {admin_league: invalid_attributes}, session: valid_session
        expect(assigns(:admin_league)).to be_a_new(Admin::League)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_league" do
        league = Admin::League.create! valid_attributes
        put :update, params: {id: league.to_param, admin_league: new_attributes}, session: valid_session
        league.reload
      ...
      it "assigns the requested admin_league as @admin_league" do
        league = Admin::League.create! valid_attributes
        put :update, params: {id: league.to_param, admin_league: valid_attributes}, session: valid_session
        expect(assigns(:admin_league)).to eq(league)
      end
    ...
    context "with invalid params" do
      it "assigns the admin_league as @admin_league" do
        league = Admin::League.create! valid_attributes
        put :update, params: {id: league.to_param, admin_league: invalid_attributes}, session: valid_session
        expect(assigns(:admin_league)).to eq(league)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the admin_leagues list" do
      league = Admin::League.create! valid_attributes
      delete :destroy, params: {id: league.to_param}, session: valid_session
      expect(response).to redirect_to(admin_leagues_url)
    end
  end
